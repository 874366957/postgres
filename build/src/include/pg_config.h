...
#define CONFIGURE_ARGS " '--prefix=/tmp/pg_install' '--enable-cassert' '--without-readline'"
...
#define PG_VERSION_STR "PostgreSQL 19devel on x86_64-pc-linux-gnu, compiled by gcc (Ubuntu 13.3.0-6ubuntu2~24.04) 13.3.0, 64-bit"

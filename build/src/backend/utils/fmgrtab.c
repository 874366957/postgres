...
const FmgrBuiltin fmgr_builtins[] = {
  ...
  { 8052, 1, true, true, "pg_get_publication_sequences", pg_get_publication_sequences },
  { 8255, 1, true, false, "oidtooid8", oidtooid8 },
  { 8257, 1, true, false, "oid8in", oid8in },
  { 8258, 1, true, false, "oid8out", oid8out },
  { 8259, 1, true, false, "oid8recv", oid8recv },
  { 8260, 1, true, false, "oid8send", oid8send },
  { 8268, 2, true, false, "oid8eq", oid8eq },
  { 8269, 2, true, false, "oid8ne", oid8ne },
  { 8270, 2, true, false, "oid8lt", oid8lt },
  { 8271, 2, true, false, "oid8le", oid8le },
  { 8272, 2, true, false, "oid8gt", oid8gt },
  { 8273, 2, true, false, "oid8ge", oid8ge },
  { 8274, 2, true, false, "oid8larger", oid8larger },
  { 8275, 2, true, false, "oid8smaller", oid8smaller },
  { 8280, 1, true, false, "hashoid8", hashoid8 },
  { 8281, 2, true, false, "hashoid8extended", hashoid8extended },
  { 8282, 2, true, false, "btoid8cmp", btoid8cmp },
  { 8283, 1, true, false, "btoid8sortsupport", btoid8sortsupport },
  { 8284, 1, true, false, "btoid8skipsupport", btoid8skipsupport },
  { 8321, 1, true, false, "regdatabasein", regdatabasein },
  { 8322, 1, true, false, "regdatabaseout", regdatabaseout },
  { 8323, 1, true, false, "to_regdatabase", to_regdatabase },
  { 8324, 1, true, false, "regdatabaserecv", regdatabaserecv },
  { 8325, 1, true, false, "regdatabasesend", regdatabasesend },
  { 8411, 2, true, true, "multirange_minus_multi", multirange_minus_multi },
  { 8412, 2, true, true, "range_minus_multi", range_minus_multi },
  { 8488, 1, false, false, "pg_error_on_null", pg_error_on_null },
  { 8745, 1, true, false, "pg_stat_get_function_stat_reset_time", pg_stat_get_function_stat_reset_time },
  { 9001, 0, true, false, "pg_get_multixact_stats", pg_get_multixact_stats },
  { 9127, 1, true, false, "pg_stat_get_stat_reset_time", pg_stat_get_stat_reset_time },
  { 9159, 0, false, false, "binary_upgrade_create_conflict_detection_slot", binary_upgrade_create_conflict_detection_slot },
  { 9314, 0, true, true, "pg_get_dsm_registry_allocations", pg_get_dsm_registry_allocations },
  { 9947, 1, false, false, "pg_restore_extended_stats", pg_restore_extended_stats },
  { 9948, 5, false, false, "pg_clear_extended_stats", pg_clear_extended_stats }
};

const int fmgr_nbuiltins = (sizeof(fmgr_builtins) / sizeof(FmgrBuiltin));

const Oid fmgr_last_builtin_oid = 9948;

const uint16 fmgr_builtin_oid_index[9949] = {
